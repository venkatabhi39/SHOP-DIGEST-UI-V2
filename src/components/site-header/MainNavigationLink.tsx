...
import { Dropdown, NavbarLink, MegaMenu } from 'flowbite-react';
...
export const MainNavigationLink: React.FC<IMainNavigationLinkProps> = ({ label, hasMenu }) => (
  <>
    {hasMenu?.length ? (
      <Dropdown
        label={
          <div className="text-gray-700 hover:!text-primary text-15  border-b border-gray-100 lg:border-none w-full lg:w-auto text-left py-2 pr-4 pl-3 lg:py-0 lg:pr-0 lg:pl-0 md:px-1">
            {label}
          </div>
        }
        inline
