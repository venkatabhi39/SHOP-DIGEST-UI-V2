...
export const SecondaryHeaderLink: React.FC<ISecondaryHeaderLinkProps> = ({ key, label }) => (
  <NavbarLink
    href="/"
    className={`font-sans transition-colors block border-0 py-2 md:py-2 px-0 lg:p-0 font-medium text-xs tracking-wide uppercase text-sdGray-text hover:!text-primary ${
