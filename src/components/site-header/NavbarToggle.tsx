...
export const NavbarToggle: React.FC<INavbarToggleProps> = ({ onClick }) => (
  <IconButton
    ...
    className="ml-0 mr-2 ring-gray-100 lg:hidden hover:bg-white hover:text-sdGray-text focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
