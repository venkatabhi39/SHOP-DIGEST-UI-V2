        ...
        <div className="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
          ...
          <form>
            <div className="md:h-[58px] bg-white mx-auto max-w-2xl sm:flex items-center sm:space-x-3 p-2  border rounded-lg sm:rounded-full shadow-md  dark:bg-slate-900 dark:border-gray-700 dark:shadow-gray-900/[.2] justify-start">
              {isSticky && (
                <>
                  <div className="flex items-center pb-2 sm:pb-0 sm:flex-[1_0_0%] w-full xl:max-w-28">
                    <select
                      id="referring-domain"
              ...
              <div className="flex items-center pb-2 sm:pb-0 sm:flex-[1_0_0%] w-full xl:max-w-36">
                <select
                  id="referring-domain"
